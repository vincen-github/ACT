...
def get_cfg():
    ...
    parser.add_argument(
        "--method", type=str, choices=METHOD_LIST, default="act", help="loss type",
    )
    parser.add_argument(
        "--num_samples",
        type=int,
    ...
    addf("--crop_s0", default=0.08, help="crop size from")
    ...
    parser.add_argument(
        "--s_eps", type=float, default=0, help="eps for stability for standardization"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--s_size", type=int, default=128, help="size of sub-batch for the estimation of standardization martrix"
    )
    parser.add_argument(
        "--s_iter",
        type=int,
        default=1,
        help="iterations for standardization matrix estimation",
    )
    ...
    parser.add_argument(
        "--bs", type=int, default=256, help="number of original images in batch N",
    )
    parser.add_argument(
        "--drop",
        type=int,
